				...
				<div className="flex items-center justify-between p-6 border-b" style={{ borderColor: 'var(--makeda-gold)' }}>
					<div>
						<h2 className="text-2xl font-serif" style={{ fontFamily: "'Playfair Display', serif", color: 'var(--makeda-green)' }}>
							{isSignup ? 'Join Makeda Threads' : 'Welcome Back'}
						</h2>
					...
					<div className="px-6 pt-6">
						...
						<div className="grid grid-cols-3 gap-2 mb-4">
							<button
								...
								className={`py-3 px-2 border-2 rounded transition-all text-xs ${selectedRole === 'customer' ? 'border-opacity-100' : 'border-gray-300'
									}`}
								style={{
							...
							<button
								...
								className={`py-3 px-2 border-2 rounded transition-all text-xs ${selectedRole === 'brand-partner' ? 'border-opacity-100' : 'border-gray-300'
									}`}
								style={{
							...
							<button
								...
								className={`py-3 px-2 border-2 rounded transition-all text-xs ${selectedRole === 'admin' ? 'border-opacity-100' : 'border-gray-300'
									}`}
								style={{
